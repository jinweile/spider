...
L_calendar.prototype = {
	...
	SelectYearInnerHTML : function(strYear) // 年份的下拉框
	{
		...
		var m = (strYear) ? new Date().getFullYear() : new Date().getFullYear();
		// --gaoyj 2009.8.6 START
		// var today = new Date();
		// var m_year = today.getYear();
		// var m = (strYear) ? new Date().getFullYear(); : new
		// Date().getFullYear();
